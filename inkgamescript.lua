...
--game:GetService("Players").LocalPlayer:Kick("OneScript Is Temporarily Down. Please wait while we bring it back discord.gg/OneScript :c")
local IS_DOWN = false

if IS_DOWN and not shared.BYPASS_VW_PROTECTION then

    game:GetService("StarterGui"):SetCore("SendNotification", {
        Title = "OneScript | Ink Game",
        Text = "OneScript is currently down! Please wait until we patch the anticheat once again :c",
        Duration = 10
    })

    game:GetService("StarterGui"):SetCore("SendNotification", {
        Title = "OneScript | Discord",
        Text = "Join discord.gg/OneScript for updates",
        Duration = 10
    })
    ...
    pcall(function()
        game:GetService("StarterGui"):SetCore("SendNotification", {
            Title = "OneScript | Ink Game | Announcment",
            Text = "Warning! After Ink Game updates OneScript might become detected so be careful until we fully verify that vw works!",
            Duration = 10
        })
    end)
    ...
    if (shared.CheatEngineMode or not verified) and not shared.AcceptedRisksOfBan then
        if not shared.CheatEngineMode and not verified then
            ...
            game:GetService("StarterGui"):SetCore("SendNotification", {
                Title = "OneScript | Currently Tested Executors",
    ...
    --[[if not hookmetamethod then
        game:GetService("StarterGui"):SetCore("SendNotification", {
            Title = "OneScript - Anticheat Test | Ink Game",
            Text = "Your executor "..(hookmetamethod ~= nil and "supports ✅" or "doesn't support ❌").." the anticheat patch!",
            Duration = 10
        })
        game:GetService("StarterGui"):SetCore("SendNotification", {
            Title = "OneScript - Anticheat Test | Ink Game",
            Text = "Please use a different executor! For support: discord.gg/OneScript",
            Duration = 10
        })
        return
    end--]]
    ...
    --[[pcall(function()
        game:GetService("StarterGui"):SetCore("SendNotification", {
            Title = "OneScript | Announcment",
            Text = "Warning: Rebelling with OneScript may lead to bans. Don't join Rebels and start a new game when one starts. Sorry for the inconvenience! We are working on it",
            Duration = 8
        })
    end)--]]
    ...
    task.spawn(function()
        pcall(function()
            ...
            loadstring(game:HttpGet("https://raw.githubusercontent.com/VapeOneScript/VW-Add/"..tostring(commit).."/inkgamereducer.lua", true))()
        end)
    end)

    loadstring(game:HttpGet("https://raw.githubusercontent.com/VapeOneScript/VW-Add/"..tostring(commit).."/newinkgame.lua", true))()
end